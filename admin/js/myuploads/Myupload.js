    ...
    jQuery.ajax({
        ...
        success: function(response){
            ...
            if (error === true) {
                ...
                form.append('<input type="hidden" class="upl_link" id="'+name+'" value="'+status+'" />');
                el.find('.upl_filelist').append("<div class='upl_info' id='upl_"+name+"'><div class='upl_name' id='"+status+"'>"
