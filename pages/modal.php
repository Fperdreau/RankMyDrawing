        ...
        <div class='modal_section' id='contact' data-title='Send a message'>
            <form id='contact_form'>
                <div class='formcontrol'>
                    <label for='name'>Your name</label><input type='text' name='name' id='contact_name' placeholder='Your name' required>
                </div>
                <div class='formcontrol'>
                    <label for='mail'>E-mail</label><input type='email' name='mail' id='contact_mail' placeholder='Your email' required>
                </div>
                <div class='formcontrol'>
